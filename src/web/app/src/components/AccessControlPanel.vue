<template>
  <div v-loading="isAccessControlPanelLoading">
    ...
    <el-input :value="currentUrl" @focus="$event.target.select()">
    ...
    >
      <el-table-column prop="userIdentifier" label="Email"> </el-table-column>
      <el-table-column label="Access Level">
        <template slot-scope="scope">
          ...
          >
            ...
            <el-option label="Edit" value="CAN_WRITE"></el-option> </el-select
          >&nbsp;
          <el-button
            type="danger"
